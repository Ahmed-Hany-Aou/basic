...
@endphp
   ...
   <header>
    ...
    <li class="{{ ($route == 'home.about')? 'active' : '' }}"><a href="#">About</a></li>


    <li><a href="services-details.html">Services</a></li>

    <li class="{{ ($route == 'home.portfolio') ? 'active' : '' }}"><a href="#">Portfolio</a>
         
    </li>    

    <li class="{{ ($route == 'home.blog') ? 'active' : '' }}"><a href="#">Our Blog</a>
        
    </li>
    <li class="{{ ($route == 'contact.me') ? 'active' : '' }}"><a href="#">contact me</a></li>
    </ul>
    </div>
